module UsersHelper
  ...
  def user_icon_edit(user)
    if user.image?
      image_tag user.image.url, id: :img_prev, class: "user-edit-image", style: "
      width: 210px;
      height: 210px;
      border-radius: 50%;
      ...
      image_tag 'https://img-photo.s3-ap-northeast-1.amazonaws.com/uploads/content_image/user_default.png', id: :img_prev, class: "user-edit-image", style: "
      width: 210px;
      height: 210px;
      border-radius: 50%;
      display: inline-block;
