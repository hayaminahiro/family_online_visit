class UsersController < ApplicationController
  before_action :set_user,               only: %i[show edit update destroy video_room set_room room_required]
  ...
  before_action :correct_user,           only: %i[show update destroy video_room]
