...
module FacilityDecorator
  ...
  def facility_edit_background_image
    if image?
      image_tag image.url, id: :mobile_prev, class: "home-image", onClick: "$('.image_uploading_mobile').click()"
    else
      month = Time.zone.today.month
      if month.in?([12, 1, 2])
        image_tag 'https://img-photo.s3-ap-northeast-1.amazonaws.com/uploads/content_image/winter.jpg', id: :mobile_prev, class: "home-image", onClick: "$('.image_uploading_mobile').click()"
      elsif month.in?([3, 4, 5])
        image_tag 'https://img-photo.s3-ap-northeast-1.amazonaws.com/uploads/content_image/spring.jpg', id: :mobile_prev, class: "home-image", onClick: "$('.image_uploading_mobile').click()"
      elsif month.in?([6, 7, 8])
        image_tag 'https://img-photo.s3-ap-northeast-1.amazonaws.com/uploads/content_image/summer.jpg', id: :mobile_prev, class: "home-image", onClick: "$('.image_uploading_mobile').click()"
      elsif month.in?([9, 10, 11])
        image_tag 'https://img-photo.s3-ap-northeast-1.amazonaws.com/uploads/content_image/+autumn.jpg', id: :mobile_prev, class: "home-image", onClick: "$('.image_uploading_mobile').click()"
      end
    end
  end
